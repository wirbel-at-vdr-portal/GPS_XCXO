...
- the pwm signal is RC filtered, we need to put a bit effort in this filter. We want more than 120dB frequency suppression for the PWM frequency. We really need every of the 16 bit.
